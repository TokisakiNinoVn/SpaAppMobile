...
class ListTechnicianOrderBook extends StatefulWidget {
  const ListTechnicianOrderBook({super.key});

  @override
  State<ListTechnicianOrderBook> createState() => _ListTechnicianOrderBookState();
}

class _ListTechnicianOrderBookState extends State<ListTechnicianOrderBook> {
  ...
  double? latValue;     // Sửa Double? -> double?
  double? longValue;    // Sửa Double? -> double?
