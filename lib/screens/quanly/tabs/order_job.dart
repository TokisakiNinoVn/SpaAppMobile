...
import 'package:spa_app/routes/config/managers_router_config.dart';
...
class OrderJobTab extends StatefulWidget {
  const OrderJobTab({super.key});

  @override
  State<OrderJobTab> createState() => _ManagementPostOrderState();
}

class _ManagementPostOrderState extends State<OrderJobTab> {
        ...
        child: FloatingActionButton.extended(
          onPressed: () async {
            final result = await context.push<bool>(
              ManagersRouterConfig.createOrderPost,
            );
  ...
  Widget _buildOrderCard(dynamic order) {
    ...
    return InkWell(
      ...
      onTap: () {
        context.push(
          ManagersRouterConfig.listTechnicianApply,
          extra: order,
        );
      },
      child: Container(
