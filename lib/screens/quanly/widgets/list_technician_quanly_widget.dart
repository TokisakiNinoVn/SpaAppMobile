...
class QuanLyListTechnicianTab extends StatefulWidget {
  const QuanLyListTechnicianTab({super.key});
  @override
  _QuanLyListTechnicianTabState createState() =>
      _QuanLyListTechnicianTabState();
}

class _QuanLyListTechnicianTabState extends State<QuanLyListTechnicianTab> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (hasTechnician) ...[
                    ...
                    // _buildDetailRow(
                    //   'Mô tả kinh nghiệm',
                    //   technician?['experienceDescription'],
                    // ),
