...
class DetailsNotificationScreen extends StatefulWidget {
  @override
  State<DetailsNotificationScreen> createState() => _ListDetailsNotificationScreenState();
}

class _ListDetailsNotificationScreenState extends State<DetailsNotificationScreen> {
